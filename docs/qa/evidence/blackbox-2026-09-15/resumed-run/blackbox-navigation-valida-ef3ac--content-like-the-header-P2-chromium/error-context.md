...
- Name: blackbox\navigation-validation.spec.ts >> [BB-015] Footer About should reach the About content like the header @P2
- Location: qa\automation\blackbox\navigation-validation.spec.ts:76:5
...
Expected: "CRAFTING THE FUTURE OF HEADWEAR."
...
```ts
  ...
  58  |   await page.goto('/');
  59  |   await expect(page.getByRole('heading', { level: 1 })).toHaveAccessibleName('CROWN YOUR INDIVIDUALITY.');
  ...
  64  |   await expect(page.getByRole('heading', { level: 1 })).toHaveAccessibleName('CROWN YOUR INDIVIDUALITY.');
