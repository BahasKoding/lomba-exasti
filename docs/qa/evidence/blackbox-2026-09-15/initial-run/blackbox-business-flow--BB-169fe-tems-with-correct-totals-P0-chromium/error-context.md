...
- Name: blackbox\business-flow.spec.ts >> [BB-005] Cart should order only selected items with correct totals @P0
- Location: qa\automation\blackbox\business-flow.spec.ts:64:5
