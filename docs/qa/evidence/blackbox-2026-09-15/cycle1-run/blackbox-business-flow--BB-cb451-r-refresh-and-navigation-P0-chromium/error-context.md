...
- Name: blackbox\business-flow.spec.ts >> [BB-001] Catalog should persist added item after refresh and navigation @P0
- Location: qa\automation\blackbox\business-flow.spec.ts:6:5
