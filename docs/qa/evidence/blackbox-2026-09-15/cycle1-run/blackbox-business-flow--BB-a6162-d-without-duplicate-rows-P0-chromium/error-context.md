...
- Name: blackbox\business-flow.spec.ts >> [BB-002] Cart should aggregate a rapid double add without duplicate rows @P0
- Location: qa\automation\blackbox\business-flow.spec.ts:21:5
...
Locator:  getByRole('button', { name: 'Remove TOPI 4', exact: true })
Expected: 1
Received: 0
Timeout:  5000ms

Call log:
  - Expect "toHaveCount" getByRole('button', { name: 'Remove TOPI 4', exact: true }) with timeout 5000ms
    ...
    - main [ref=e21]:
      ...
      - generic [ref=e27]:
        - generic [ref=e28]:
          ...
          - generic [ref=e34]: "Total: Rp 130.000"
        - generic [ref=e36]:
        ...
        - button "ORDER (2)" [ref=e57] [cursor=pointer]
    - contentinfo [ref=e59]:
      - generic [ref=e60]:
        - generic [ref=e61]:
          - generic [ref=e62]:
