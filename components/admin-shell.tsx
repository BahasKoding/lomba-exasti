            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.label}
                  href={item.href}
                  className={`text-sm font-semibold transition-colors duration-200 hover:opacity-75 ${isActive ? "font-extrabold text-[#1F2022]" : "text-[#1F2022]/80"
                    }`}
                >
                  {item.label}
                </Link>
            ...
            {sidebarItems.map((item, idx) => {
              ...
              return (
                <Link
                  key={idx}
                  href={item.href}
                  className={`group flex items-center rounded-none px-4 py-2.5 text-sm font-semibold transition-all duration-200 ${isActive
